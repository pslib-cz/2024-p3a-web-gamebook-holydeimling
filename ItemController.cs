...
namespace GamebookTest1.Server.Controllers
{
    ...
    public class ItemController : ControllerBase
    {
        ...
        public async Task<ActionResult<Item>> GetItem(int id)
        {
            try
            {
                var item = await _context.Items.Include(i => i.ItemImage).FirstOrDefaultAsync(i => i.ItemId == id);
        ...
        )
        {
            try
            {
                ...
                var newItem = new Item
                {
                    ...
                    ItemImage = image // Associate the image with the item
                };
            ...
            {
                _logger.LogError(ex, "Error occurred while creating item with image.");
                return StatusCode(500, "Internal server error");
            }
        }
